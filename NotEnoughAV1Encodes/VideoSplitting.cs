    ...
    class VideoSplitting
    {
        ...
        public static void SplitVideo(string videoInput, int chunkLength, string reencodeCodec, bool reencode, bool beforereencode)
        {
            ...
            if (reencode && beforereencode)
            {
                ...
                ffmpegCommand = "/C ffmpeg.exe -i " + '\u0022' + videoInput + '\u0022' + " " + MainWindow.subtitleFfmpegCommand + " " + MainWindow.ffmpegFramerateSplitting + " " + MainWindow.trimCommand + MainWindow.deinterlaceCommand + MainWindow.cropCommand + " -map_metadata -1 -c:v " + reencodeCodec + " -an " + '\u0022' + MainWindow.tempPath + "\\temp_prereencode.mkv" + '\u0022';
