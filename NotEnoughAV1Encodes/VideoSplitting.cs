    ...
    class VideoSplitting
    {
        ...
        public static void SplitVideo(string videoInput, int chunkLength, string reencodeCodec, bool reencode, bool beforereencode)
        {
            ...
            if (reencode && beforereencode)
            {
                ...
                ffmpegCommand = "/C ffmpeg.exe -i " + '\u0022' + videoInput + '\u0022' + MainWindow.ffmpegFramerateSplitting + " -map_metadata -1 " + MainWindow.subtitleFfmpegCommand + " " + MainWindow.deinterlaceCommand +  " -c:v " + reencodeCodec + " -an " + '\u0022' + MainWindow.tempPath + "\\temp_prereencode.mkv" + '\u0022';
            ...
            else if(reencode && beforereencode == false)
            {
                ...
                ffmpegCommand = "/C ffmpeg.exe -i " + '\u0022' + videoInput + '\u0022' + MainWindow.ffmpegFramerateSplitting + " -map_metadata -1 " + MainWindow.subtitleFfmpegCommand + " " + MainWindow.deinterlaceCommand + " -c:v " + reencodeCodec + " -f segment -segment_time " + chunkLength + " -an " + '\u0022' + MainWindow.tempPath + "\\Chunks\\out%0d.mkv" + '\u0022';
                SmallFunctions.Logging("VideoSplitting() ReencodeCommand: " + ffmpegCommand);
                SmallFunctions.ExecuteFfmpegTask(ffmpegCommand);
            }
