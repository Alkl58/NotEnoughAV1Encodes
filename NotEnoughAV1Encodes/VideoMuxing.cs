            ...
            if (SmallFunctions.Cancel.CancelAll == false)
            {
                ...
                if (MainWindow.audioEncoding == false)
                {
                    ...
                    else if (MainWindow.subtitleHardcoding == false)
                    {
                        ...
                        await Task.Run(() => SmallFunctions.ExecuteFfmpegTask(ffmpegCommand));
                        ffmpegCommand = "/C ffmpeg.exe -i " + '\u0022' + MainWindow.tempPath + "\\withoutaudio.mkv" + '\u0022' + " -i " + MainWindow.tempPath + "\\Subtitles\\subtitle.mkv" + " -map_metadata -1 -map 0:v -map 1:s -c copy " + '\u0022' + MainWindow.videoOutput + '\u0022';
                        await Task.Run(() => SmallFunctions.ExecuteFfmpegTask(ffmpegCommand));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        ffmpegCommand = "/C ffmpeg.exe -i " + '\u0022' + MainWindow.tempPath + "\\withoutaudio.mkv" + '\u0022' + " -i " + '\u0022' + MainWindow.tempPath + "\\AudioEncoded\\audio.mkv" + '\u0022' + " -i " + MainWindow.tempPath + "\\Subtitles\\subtitlecustom.mkv" + " -map_metadata -1 -map 0:v -map 1:a -map 2:s -c copy " + '\u0022' + MainWindow.videoOutput + '\u0022';
                        await Task.Run(() => SmallFunctions.ExecuteFfmpegTask(ffmpegCommand));
                    }
                    else
                    {
